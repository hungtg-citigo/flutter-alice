...
import 'package:demo_flutter_inspector/posts_service.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void _runDioRequests() async {
    Map<String, dynamic> body = {"title": "foo", "body": "bar", "userId": "1"};
    _dio.get("https://httpbin.org/redirect-to?url=https%3A%2F%2Fhttpbin.org", queryParameters: {'id': 12, 'name': 'dio'});
