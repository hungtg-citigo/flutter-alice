...
class AliceCore {
  ...
  /// Should inspector use option share only curl
  bool enableShareOnlyCurl;
  ...
  /// Set option only share curl
  void setEnableOnlyCurl(bool enable) {
    this.enableShareOnlyCurl = enable;
  }
