...
class AliceSaveHelper {
  ...
  static Future<String> _buildAliceLog() async {
    ...
    stringBuffer.write("HTTP Inspector\n");
  ...
  static Future<String> buildCallLog(AliceHttpCall call, {bool enableShareOnlyCurl = false}) async {
    try {
      if (enableShareOnlyCurl) {
        return _buildOnlyCurl(call);
      }
