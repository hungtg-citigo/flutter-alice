...
import 'package:flutter_alice/ui/widget/alice_call_preview_curl_widget.dart';
...
class _AliceCallDetailsScreenState extends State<AliceCallDetailsScreen>
  ...
  Future<String> _getSharableResponseString() async {
    return AliceSaveHelper.buildCallLog(
        widget.call, enableShareOnlyCurl: widget.core.enableShareOnlyCurl);
  }
  ...
  List<Widget> _getTabBars() {
    ...
    widgets.add(Tab(icon: Icon(Icons.file_open), text: "Curl"));
    return widgets;
  }
  ...
  List<Widget> _getTabBarViewList() {
    ...
    widgets.add(AliceCallPreviewCurlWidget(widget.call));
    return widgets;
  }
}
